...
#jpeg("E:/MainProject/PROJECT_MRSA_MSSA/FIGURES/FIGURE_CLUSTERING_v3_shape.jpeg", width = 25, height = 20, units = 'in', res = 500)
...
HC_plot2(DATA=featureMatrix,Truelabels=TRUE_LABELS_all,Method='COR',MAIN='a',leg=F,input_cex=3)
...
HC_plot2(data,TRUE_LABELS_all,Method='BIN',leg=F,MAIN='c',input_cex=3)
